...
<script>
    ...
    <div class="aboutimg_container">
        ...
        <section class="part1">
          <p class="p1_one">Rapid prototyping</p>
          <p class="p2_two">Validate ideas quickly with low-cost AI prototypes. We deliver focused proof-of-concepts so teams can test functionality, gather feedback, and decide what to scale—faster and with less risk.</p>
        </section>
    </div>
    ...
    <section class="onboarding">
      <div class="copy1">
        <div class="copy">
          <h2>Proof of Concept (PoC) Development</h2>
          <p>
            At the earliest stage of rapid prototyping, AI-Solutions focuses on Proof of Concept (PoC) development to quickly validate whether an idea is technically feasible. Instead of investing large amounts of time and resources into full product development, lightweight prototypes are created to test a single feature or workflow. This approach allows organizations to identify potential challenges early and determine if the concept has practical value, ultimately helping them avoid unnecessary spending on unworkable solutions.
          </p>
        ...
        <div class="visual">
          ...
          <img src="./poc.png" alt="Mobile onboarding screens">
        </div>
      </div>
  ...
  <div class="visual">
    <img src="./code.png" alt="Mobile onboarding screens">
  </div>

  <div class="copy">
    <h2>Low-Code/No-Code Prototyping</h2>
    <p>
      For businesses that want to move fast without heavy technical investment, AI-Solutions offers low-code and no-code prototyping. Using drag-and-drop platforms and AI-assisted tools, functional mockups can be built in a matter of days rather than months. This approach is especially beneficial for clients without large technical teams, as it enables them to bring ideas to life quickly. By cutting down on development complexity, low-code/no-code prototyping ensures faster delivery while keeping costs under control.
    </p>
  </div>
</div>
      ...
      <div class="copy3">
        <div class="copy">
          <h2>Interactive Mockups & Wireframes </h2>
          <p>
            
            Another key part of rapid prototyping at AI-Solutions is the creation of interactive mockups and wireframes. These clickable prototypes simulate the end-user experience, allowing stakeholders to interact with a working model of the product before development begins. By collecting early feedback from employees, customers, or partners, organizations can refine design and usability, ensuring that the final product meets user expectations. This step reduces the likelihood of costly design changes later and ensures smoother development.
          </p>
        ...
        <div class="visual">
          <!-- replace with your phones image -->
          <img src="./wireframe.png" alt="Mobile onboarding screens">
        </div>
      </div>
    ...
    <div class="solutioncase-card">
        <div class="head_details">
            <h3>USE CASE</h3>
            <h2> <i class="fa-brands fa-hire-a-helper">  QuickBuild</i> </h2>
            <p>
              QuickBuild compresses months of exploration into weeks. Product teams iterate live with users, validate assumptions, and prioritize features based on evidence—not guesswork.
            </p>
        </div>   
        <div class="numeric">
