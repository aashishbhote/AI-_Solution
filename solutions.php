...
<script>
    ...
    <div class="aboutimg_container">
        ...
        <section class="part1">
          <p class="p1_one">AI Virtual Assistant</p>
          <p class="p2_two">Our AI Virtual Assistant is an always-available digital helper for employees and customers.
            It answers enquiries, automates repetitive tasks, and routes requests to the right teams.
            With 24/7 availability and faster responses, it keeps work moving smoothly.</p>
        </section>
    </div>
    ...
    <section class="onboarding">
      <div class="copy1">
        <div class="copy">
          <h2>Effortless customer onboarding</h2>
          <p>
            Simplify how prospects engage with AI-Solutions through a mobile-first, intuitive flow that reduces drop-offs.
            The journey combines real-time KYC checks and automated document capture/verification with guided help from our
            AI Virtual Assistant. Without creating an account, customers can submit their name, email, phone, company,
            country, job title and job details via the Contact form—while a password-protected admin area tracks inquiry
            volumes and trends. Built with OWASP-aligned controls, the experience is fast, secure, and designed to convert
            interest into qualified opportunities.
          </p>
        ...
        <div class="visual">
          ...
          <img src="./customer.png" alt="Mobile onboarding screens">
        </div>
      </div>
  ...
  <div class="visual">
    <img src="./onboarding-phones.png" alt="Mobile onboarding screens">
  </div>

  <div class="copy">
    <h2>Smarter Work with AI Virtual Assistant</h2>
    <p>
      Empower employees and customers with an always-available digital helper that responds instantly to enquiries,
      automates repetitive tasks, and directs requests to the right teams. The AI Virtual Assistant reduces support
      workload, improves turnaround time, and delivers consistent resolutions across channels. With 24/7 availability,
      it ensures business continuity and helps organizations focus on strategic goals instead of routine tasks.
    </p>
  </div>
</div>
      ...
      <div class="copy3">
        <div class="copy">
          <h2>Smart Enquiry Routing </h2>
          <p>
            
            When a request requires human involvement, the AI Virtual Assistant intelligently routes it to the most appropriate department or specialist. This minimizes delays and ensures that enquiries are resolved by the right person as quickly as possible.
          </p>
        ...
        <div class="visual">
          <!-- replace with your phones image -->
          <img src="./enquiry.png" alt="Mobile onboarding screens">
        </div>
      </div>
    ...
    <div class="solutioncase-card">
        <div class="head_details">
            <h3>USE CASE</h3>
            <h2> <i class="fa-brands fa-hire-a-helper">  SmartHelp</i> </h2>
            <p>
              SmartHelp provides instant, reliable support across channels. It handles thousands of enquiries
              daily, reducing workload for support teams and delivering consistent resolutions.
            </p>
        </div>   
        <div class="numeric">
