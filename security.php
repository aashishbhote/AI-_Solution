...
<header class="page-hero">
    <div class="container">
      <nav class="breadcrumbs"><a href="./index.php">Home</a><span>/</span><a href="./blogs.php">Blogs</a><span>/</span><span>Security by Design</span></nav>
      <h1>Security by Design: Practical OWASP Controls for Admins</h1>
      <div class="meta"><span class="pill pill--security">Security</span><time datetime="2025-05-02">2 May 2025</time> · 6 min read</div>
    </div>
  </header>

  <main class="container article">
    <article class="content">
      <p class="lead">Here’s a short list that gets you most of the benefit with minimal overhead.</p>

      <h2 id="auth">Authentication & sessions</h2>
      <ul>
        <li>Hash with <strong>Argon2id</strong> (or bcrypt), enforce strong passwords, and enable 2FA.</li>
        <li>Use HTTP-only, Secure, SameSite cookies; add idle timeout and short max age.</li>
      </ul>

      <h2 id="csrf">CSRF & input validation</h2>
      <p>Protect state-changing requests with synchroniser tokens. Centralise validation and use prepared statements/ORM.</p>

      <h2 id="headers">Security headers & TLS</h2>
      <pre><code>Content-Security-Policy: script-src 'self' 'nonce-XYZ'; object-src 'none';
Strict-Transport-Security: max-age=31536000; includeSubDomains; preload
X-Frame-Options: DENY
Referrer-Policy: no-referrer
X-Content-Type-Options: nosniff</code></pre>

      <h2 id="audit">Auditing & recovery</h2>
      <p>Record logins, exports, and content changes. Keep encrypted backups and test restores regularly.</p>

      <div class="post-cta">
        <h3>Harden your admin area</h3>
        <p>Our <a href="./solutions3.php">Security by Design</a> module adds headers, CSRF, rate-limits, and audit logs out of the box.</p>
        <a class="btn" href="./contact.php">Request a review</a>
      </div>
    </article>
    ...
    <aside class="toc">
      <h4>Contents</h4>
      <ul>
        <li><a href="#auth">Auth & sessions</a></li>
        <li><a href="#csrf">CSRF & validation</a></li>
        <li><a href="#headers">Headers & TLS</a></li>
        <li><a href="#audit">Auditing & recovery</a></li>
      </ul>
    </aside>
  </main>
