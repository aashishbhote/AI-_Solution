...
<header class="page-hero">
  ...
  <header class="page-hero">
    <div class="container">
      <h1>Rapid AI Prototyping: Validate in Weeks, Not Months</h1>
      <div class="meta"><span class="pill pill--proto">Prototyping</span><time datetime="2025-07-30">30 Jul 2025</time> · 5 min read</div>
    </div>
  </header>

  <main class="container article">
    <article class="content">
      <p class="lead">Prototypes answer one question: “Is this worth building?” Here’s how we deliver safe, low-cost proof without touching production systems.</p>

      <h2 id="scope">Scope like a scientist</h2>
      <ul>
        <li>Define <strong>one measurable outcome</strong> (e.g., deflect 20% password resets).</li>
        <li>List constraints: data access, budget, timeline, stakeholders.</li>
        <li>Write acceptance criteria and a stop/go decision rule.</li>
      </ul>

      <h2 id="data">Use demo data by default</h2>
      <p>We mirror formats, not identities. Seed with synthetic examples to avoid PII and compliance work during discovery.</p>

      <h2 id="build">Build the narrowest slice</h2>
      <p>Clickable flows or a thin working PoC. Focus on the <em>path to value</em>, not polish.</p>

      <h2 id="measure">Measure, decide, hand over</h2>
      <ul>
        <li>Collect usage and outcome metrics (no raw transcripts).</li>
        <li>Hold a demo, capture feedback, then hand over code and notes.</li>
        <li>Decide: scale, iterate, or stop.</li>
      </ul>

      <div class="post-cta">
        <h3>Prototype with us</h3>
        <p>Our <a href="./solutions1.php">Rapid Prototyping</a> package includes scope workshop, demo build, and a decision review in 2–3 weeks.</p>
    ...
    <aside class="toc">
      ...
      <ul>
        ...
        <li><a href="#data">Demo data</a></li>
        <li><a href="#build">Narrow slice</a></li>
        <li><a href="#measure">Measure & decide</a></li>
      </ul>
    </aside>
  </main>
