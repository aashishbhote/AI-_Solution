...
<link rel="stylesheet" href="./style.css?v=2">
    <link rel="stylesheet" href="./about.css?=v3">
...
(function () {
  ...
  <div class="slide fade">
    ...
    <section class="part1">
      <p class="p1_one">Seamless <strong>Automation</strong>, Stronger <strong>Collaboration</strong></p>
      <p class="p2_two">AI-driven tools reduce repetitive tasks,<br> giving teams more time to innovate together.</p>
    </section>
  </div>

  <!-- Slide 2 -->
  <div class="slide fade">
    <img src="./aiabout.png" alt="">
    <section class="part1">
  ...
  <!-- Slide 3 -->
  <div class="slide fade">
    <img src="./aiabout1.png" alt="">
    <section class="part1">
      <p class="p1_one">Data-Powered <strong>Insights</strong>, Smarter <strong>Decisions</strong></p>
      <p class="p2_two">Turn complex data into actionable strategies,<br> driving business growth and efficiency.</p>
    </section>
  </div>
...
<div class="pillar_container">
  ...
  <p>Our Core Values are anchored by our Culture Pillars , guiding the way we collaborate, innovate, and achieve success together.</p>
  <img src="./pillar.png" alt="">
</div>

<div class="flex_container">
  <div class="flex">
    <h2>We begin with Trust</h2>
    <p>We build relationships on honesty and reliability, ensuring confidence among our teams and with our customers.</p>
  </div>
  <div class="flex">
    <h2>We act with Integrity</h2>
    <p>We uphold the highest ethical and moral principles, taking full ownership of our actions while focusing on positive outcomes.</p>
  </div>
  <div class="flex">
    <h2>We persevere with Grit</h2>
    <p>We remain determined, resilient, and focused, overcoming obstacles and striving for excellence in all situations.</p>
  </div>
  <div class="flex">
    <h2>Driving Innovation</h2>
    <p>We focus on creating forward-thinking solutions, keeping customers’ needs at the center of everything we do.</p>
  </div>
...
<div class="leader_container">
    <h1>Our Leardership</h1>
    <p>
      Our leadership team brings together visionary thinkers, experienced bankers, skilled technologists, forward-looking futurists, and industry specialists — all united in driving transformation through innovative solutions.

    </p>

    <div class="team_types" role="tablist" aria-label="team tabs">
      <a class="active" href="#" data-tab="directors" role="tab" aria-selected="true">Board of directors</a>
      <a href="#" data-tab="advisors" role="tab" aria-selected="false">Advisors</a>
      <a href="#" data-tab="leadership" role="tab" aria-selected="false">Leadership team</a>
    </div>

    <div class="teamimg_container" data-content="directors">
      <h1>Board of directors</h1>
      <div class="image_section">

        <div class="member">
          <img src="./jhon.png" alt="" class="directors"> 
          <p class="name">Jhon Matthew</p>
          <p class="role">Chairman</p>
        </div>

        <div class="member">
          <img src="./nysha.png" alt="" class="directors"> 
          <p class="name">Nysha Das</p>
          <p class="role">Director - Group Strategy</p>
        </div>

        <div class="member">
          <img src="./nakul.png" alt="" class="directors"> 
          <p class="name">Nakul Yadav</p>
          <p class="role">Director</p>
        </div>

        <div class="member">
          <img src="./sophia.png" alt="" class="directors"> 
          <p class="name">Sophia Nakarmi</p>
          <p class="role">Director</p>
        </div>

        <div class="member">
          <img src="./tyler.png" alt="" class="directors"> 
          <p class="name">Tyler Launter</p>
          <p class="role">Chairperson</p>
        </div>

        <div class="member">
          <img src="./aaynsh.png" alt="" class="directors"> 
          <p class="name">Aaynsh Poudel</p>
          <p class="role">Director</p>
        </div>
  ...
  <!-- Advisors -->
  <div class="teamimg_container" data-content="advisors" style="display:none;">
    <h1>Advisors</h1>
    <div class="image_section">

      <div class="member">
        <img src="./advisor.jpg" alt="" class="directors"> 
        <p class="name">Dr. Sarah Wilson</p>
        <p class="role">Senior Advisor - Technology</p>
      </div>
  ...
  <!-- Leadership Team -->
    <div class="teamimg_container" data-content="leadership" style="display:none;">
      <h1>Leadership team</h1>
      <div class="image_section">

        <div class="member">
          <img src="./leader1.jpg" alt="" class="directors"> 
          <p class="name">Rajiv Menon</p>
          <p class="role">Director of Engineering</p>
        </div>

        <div class="member">
          <img src="./leader2.jpg" alt="" class="directors"> 
          <p class="name">Diya Bhattrai</p>
          <p class="role">AI Solution Group</p>
        </div>

        <div class="member">
          <img src="./leader3.jpg" alt="" class="directors"> 
          <p class="name">Kamala Tiwari</p>
          <p class="role">Head of Operations</p>
        </div>

        <div class="member">
          <img src="./leader4.jpg" alt="" class="directors"> 
          <p class="name">Punit Ghimire</p>
          <p class="role">Head of Marketing</p>
        </div>

        <div class="member">
          <img src="./leader5.jpg" alt="" class="directors"> 
          <p class="name">James Theodre</p>
...
document.addEventListener("DOMContentLoaded", () => {
  const tabList = document.querySelector(".team_types");
  const tabs = tabList.querySelectorAll('a[role="tab"]');
  const panels = document.querySelectorAll('.teamimg_container[data-content]');
  ...
  function activateTab(tab) {
    ...
    // Show matching panel
    const key = tab.dataset.tab; // directors | advisors | leadership
    const panel = document.querySelector(`.teamimg_container[data-content="${key}"]`);
  ...
  // Optional: keyboard support (← → Home End)
  ...
  // Initial render (activate the one marked .active, else the first)
  const initial = tabList.querySelector('a.active[role="tab"]') || tabs[0];
  activateTab(initial);
});
</script>
