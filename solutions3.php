...
<script>
    ...
    <div class="aboutimg_container">
        ...
        <section class="part1">
          <p class="p1_one">Security by Design</p>
          <p class="p2_two">Every solution follows OWASP best practices with encryption and GDPR-aware handling. Security is built-in from day one so teams can adopt AI with confidence.</p>
        </section>
    </div>
    ...
    <section class="onboarding">
      <div class="copy1">
        <div class="copy">
          <h2>OWASP Best Practices</h2>
          <p>
            AI-Solutions solutions are aligned with the Open Web Application Security Project (OWASP) standards, covering common vulnerabilities like injection attacks, cross-site scripting (XSS), and insecure configurations. This reduces exposure to known threats and ensures compliance with industry security norms.
          </p>
        ...
        <div class="visual">
          ...
          <img src="./owasp.png" alt="Mobile onboarding screens">
        </div>
      </div>
  ...
  <div class="visual">
    <img src="./data.png" alt="Mobile onboarding screens">
  </div>

  <div class="copy">
    <h2>Data Encryption & Privacy Protection</h2>
    <p>
     Strong encryption protocols are built into all layers, from data at rest to data in transit. Combined with GDPR-aware handling, customer and organizational data is safeguarded against unauthorized access, while respecting privacy regulations across jurisdictions.
    </p>
  </div>
</div>
      ...
      <div class="copy3">
        <div class="copy">
          <h2>Continuous Monitoring & Threat Detection</h2>
          <p>
            Instead of a one-time setup, AI-Solutions enables continuous monitoring of applications and systems. Real-time alerts and AI-powered threat detection help teams identify unusual activity, block intrusions, and resolve vulnerabilities before they escalate.
          </p>
        ...
        <div class="visual">
          <!-- replace with your phones image -->
          <img src="./monitoring.png" alt="Mobile onboarding screens">
        </div>
      </div>
    ...
    <div class="solutioncase-card">
        <div class="head_details">
            <h3>USE CASE</h3>
            <h2> <i class="fa-brands fa-hire-a-helper"> SafeCore</i> </h2>
            <p>
              SafeCore embeds secure patterns across authentication, data storage, and integrations, minimizing risk while maintaining agility.
            </p>
        </div>   
        <div class="numeric">
