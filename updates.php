...
<header class="page-hero">
    <div class="container">
      <h1>Sunderland Demo Day: What We Showcased</h1>
      <div class="meta"><span class="pill pill--dex">Updates</span><time datetime="2025-08-29">29 Aug 2025</time> · 3 min read</div>
    </div>
  </header>

  <main class="container article">
    <article class="content">
      <p class="lead">Thanks to everyone who joined our in-person session in Sunderland. Here are the highlights and links to try things yourself.</p>

      <h2>What we demoed</h2>
      <ul>
        <li><strong>Affordable prototyping:</strong> a two-week path from scope to demo build using synthetic data.</li>
        <li><strong>Assistant patterns:</strong> quick replies, intent fallbacks, and guided flows.</li>
        <li><strong>Ops dashboard:</strong> deflection rate, unknown intents, and SLA warnings.</li>
      </ul>

      <h2>Where to go next</h2>
      <ul>
        <li>Read: <a href="./post-fast-poc.php">Rapid AI Prototyping</a></li>
        <li>Read: <a href="./post-assistant-ux.php">Designing a Helpful Assistant</a></li>
        <li>Service: <a href="./solutions1.php">Rapid Prototyping</a></li>
      </ul>

      <div class="post-cta">
        <h3>Want a private walkthrough?</h3>
        <p>Tell us your use-case and we’ll tailor a short demo to your team.</p>
