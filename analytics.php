...
<link rel="stylesheet" href="./style.css?v=2">
        <link rel="stylesheet" href="./articles.css?=v3">
...
<header class="page-hero">
    <div class="container">
      <nav class="breadcrumbs"><a href="./index.php">Home</a><span>/</span><a href="./blogs.php">Blogs</a><span>/</span><span>Analytics that Matter</span></nav>
      <h1>Analytics that Matter: Turning Signals into Actions</h1>
      <div class="meta"><span class="pill pill--analytics">Analytics</span><time datetime="2025-08-12">12 Aug 2025</time> · 5 min read</div>
    </div>
  </header>

  <main class="container article">
    <article class="content">
      <p class="lead">Dashboards help when they drive decisions. Use this three-layer approach to avoid vanity metrics and align to outcomes.</p>

      <h2 id="leading">Leading, lagging, learning</h2>
      <ul>
        <li><strong>Leading:</strong> signals you can act on now (unknown intents, SLA warnings).</li>
        <li><strong>Lagging:</strong> past outcomes (deflection %, resolution time).</li>
        <li><strong>Learning:</strong> experiments and changes to test next.</li>
      </ul>

      <h2 id="kpis">Five DEX/ops KPIs to start</h2>
      <ol>
        <li>Top 10 intents & deflection rate</li>
        <li>Unknown intent trend</li>
        <li>SLA breach count by team</li>
        <li>First-response time</li>
        <li>CSAT on resolved flows</li>
      </ol>

      <h2 id="access">Access & export</h2>
      <p>Give managers <em>role-based</em> access. Export CSV weekly for leadership slides; avoid raw transcripts to protect privacy.</p>

      <div class="post-cta">
        <h3>Need a dashboard that drives action?</h3>
        <p>Our <a href="./solutions2.php">Analytics & Insights</a> setup ships with the KPIs above and scheduled exports.</p>
    ...
    <aside class="toc">
      <h4>Contents</h4>
      <ul>
        <li><a href="#leading">Leading/lagging/learning</a></li>
        <li><a href="#kpis">Starter KPIs</a></li>
        <li><a href="#access">Access & export</a></li>
      </ul>
    </aside>
  </main>
